...
if ( ! function_exists( 'ober_setup' ) ) :
	...
	function ober_setup() {
		...
		// Image Sizes
		add_image_size( 'ober_155x155', 155, 155, true );
		add_image_size( 'ober_216x216', 216, 216, true );
...
function ober_scripts() {
	/*Default Scripts*/
	wp_enqueue_script( 'ober-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );
